...
const getUser = async () => {
  ...
  // Check if this is a non-existent user (has zero address)
    // For non-existent users, the contract returns [empty string, 0, zero address]
    if (!userDetails || userDetails[2] === '0x0000000000000000000000000000000000000000') {
      console.log('User does not exist in contract');
      // Just stay on the page, don't redirect or show modal automatically
      return;
    }
